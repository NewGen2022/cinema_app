...
class HelpWindow(QtWidgets.QWidget):
    def __init__(self, parent=None):
        ...
        text = """
        <p>Місця позначенні <strong><font color="blue" style="letter-spacing: 1px;">СИНІМ КОЛІРОМ</font></strong> - це вільні місця які може купити або заброньювати клієнт.
        Після натиску на вільне місце, воно змінює колір на <strong><font color="darkblue" style="letter-spacing: 1px;">ТЕМНО-СИНЄ</font></strong> .</p>
        <p>Місця позначенні <strong><font color="grey" style="letter-spacing: 1px;">СІРИМ КОЛІРОМ</font></strong> - це заброньовані місця які може купити клієнт який їх заброньювава протягом 15 хвилин, в іншому випадку місця автоматично стануть <strong><font color="blue">вільними</font></strong>. 
        Після натиску на заброньоване місце, воно змінює колір на <strong><font color="#484848" style="letter-spacing: 1px;">ТЕМНО-СІРЕ</font></strong>.</p>
        <p>Місця позначенні <strong><font color="red" style="letter-spacing: 1px;">ЧЕРВОНИМ КОЛЬОРОМ</font></strong> - це продані місця. 
        Після натиску на продане місце, воно змінює колір на <strong><font color="darkred" style="letter-spacing: 1px;">ТЕМНО-ЧЕРВОНЕ</font></strong>.</p>
        <p>Після натиску на будь-яке місце (окрім <strong><font color="red">проданого</font></strong>) з'являється вікно Замовлення з списком вибраних білетів та загальною вартістью за вибрані білети. 
        Коли клієнт вибрав білети які хоче купити/заброньювати, касир вводить електронну пошту клієнта натискає на кнопку <strong><font color="red">Купити місце</font>/<font color="grey">Заброньовати місце</font></strong>.</p>
        <p>Після повторног натиску на будь-яке місце в вікні Замовлення видаляється це місце зі списку</p>
        <p>Якщо клієнт <strong><font color="grey">заброньовав місце</font></strong> то йому прийде на електронну пошту лист з інформацією про <strong><font color="grey">заброньоване місце</font></strong>. Коли клієнт демонструє цей лист, касир за данною інформацією вибирає <strong><font color="grey">заброньованні місця</strong></font> та <strong><font color="red">продає</font></strong> цьому клієнту.</p>
        <p>Якщо термін дії <strong><font color="grey">броні</font></strong> завершився і клієнт не встиг придбати білети на ці місця, то цей лист з заброньованими місцями стає не дійсним.</p>
        <p>Якщо клієнт <strong><font color="red">купив місце</font></strong> то йому прийде на електронну пошту лист з білетами які він придбав.</p>
        <p>Після закінчення сеансу касир повинен вибрати всі <strong><font color="red">продані місця</font></strong> в залі та натиснути кнопку <strong><font color="blue">Звільнити місце</font></strong>.</p>
        """
